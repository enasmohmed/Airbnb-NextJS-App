...
function Searchbar({ placeholder }: { placeholder?: string }) {
    ...
    return <>
        <div className='flex items-center md:border-2  border-gray-300 rounded-full py-2 md:shadow-sm'>
            <input type='text' 
            value={input}
        ...
        {input && (
            <div className='absolute top-[100%] left-[50%] flex flex-col col-span-3 mx-auto translate-x-[-50%]'>
                ...
                minDate={new Date()}
                />
            <div className='flex items-center border-b border-gray-50 bg-white p-4'>
